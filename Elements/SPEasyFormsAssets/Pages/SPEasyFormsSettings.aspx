            ...
            <td class='speasyforms-editor speasyforms-panel'>
                ...
                <div id='spEasyFormsContainerDialogs'>
                    ...
                    <div id='addVisibilityRuleDialog' class='speasyforms-dialogdiv' title='Add/Edit Visibility Rule'>
                        <input type='hidden' id='visibilityRuleIndex' value=''></input>
                        <table cellpadding='5px' cellspacing='5px'>
                            <tr>
                                <td>
                                    <label for='addVisibilityRuleField'>
                                        <nobr>Field Name <span class="ms-formvalidation" title="This is a required field"> *</span>
                                        </nobr>
                                    </label>
                                </td>
                                <td class='speasyforms-input'>
                                    <input type='text' id='addVisibilityRuleField' name='addVisibilityRuleField' value='' disabled="true" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class='speasyforms-input'>
                                    <nobr>
                                        <input type='checkbox' id='addVisibilityRuleNewForm' name='addVisibilityRuleNewForm' class='speasyforms-formcb' value='' checked='true' />
                                        <label for='addVisibilityRuleNewForm'>New</label>
                                        <input type='checkbox' id='addVisibilityRuleEditForm' name='addVisibilityRuleEditForm' class='speasyforms-formcb' value='' checked='true' />
                                        <label for='addVisibilityRuleEditForm'>Edit</label>
                                        <input type='checkbox' id='addVisibilityRuleDisplayForm' name='addVisibilityRuleDisplayForm' class='speasyforms-formcb' value='' checked='true' />
                                        <label for='addVisibilityRuleDisplayForm'>Display</label>
                                    </nobr>
                                </td>
                            </tr>
                        </table>
                        <!-- { "key": "ILSPersonOrGroup", "value": { "state": "Hide", "forms": "Display;Edit;New", "title": "[Hide] the field [ILSPersonOrGroup] from [AUTHOR;Teams Tester Visitors] on the form(s) [Display;New;Edit]", "users": "AUTHOR;Teams Tester Visitors" } } -->
                    </div>
                </div>
            </td>

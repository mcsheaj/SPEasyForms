...
Discussion Boards) and libraries. The things you can configure fall into
 3 broad categories:
            ...
            <p>Most of the things marked <font color="#910000">(NEW!) </font><font color="#000000">were actually released in the updates package to v2014.01. The Stack and Star Ratings Adapter are actually brand new. Other than that, most of what’s changed in v2015.01.04 is:</font></p>
            <ol>
                <li>
...
quietly).</td>
                    ...
                    <tr>
                        ...
                        <td valign="top" width="366"><font color="#820000"><strong>New in 2015.01.04!</strong></font>Configure settings for this list, which currently means configure the jQuery UI theme for this list.</td>
                    </tr>
                    <tr>
                        <td valign="top" width="231">
                            <p align="center">
...
interface.
            ...
            <p>
                With 2015.01.04, you can configure a different jQuery UI theme for each list. On the settings page, hit the Settings
...
link to it in the snippet container rich text editor.
            ...
            <h3>3.7 Stack</h3>
            <p>
                The <strong>Stack</strong> container is new to 2015.01.04, and 
...
that will be included in the 2015.01.04 release. Hopefully somebody 

    ...
    $.spEasyForms.configManager = {
        ...
        *********************************************************************/
        set: function (options) {
            ...
            opt.currentConfig.version = "2015.01.04";
...
(function ($) {
    ...
    $.fn.cleditor = function (options) {
        if (!cssLoaded) {
            var css = $.spEasyForms.utilities.siteRelativePathAsAbsolutePath('/Style Library/SPEasyFormsAssets/2015.01.04/Css/jquery.cleditor.css');

...
(function ($, undefined) {
    ...
    function getScriptPath() {
        ...
        for (var i = 0; i < scripts.length; i++) {
            ...
            return _spPageContextInfo.siteServerRelativeUrl + "/Style Library/SPEasyFormsAssets/2015.01.05/JavaSccript/jquery.SPEasyForms.js";
        }
    }
    ...
    $.spEasyForms = {
        ...
        insertListSettingsLink: function (opt) {
            ...
            if (permissionsLink.length > 0) {
                if (generalSettings.length > 0) {
                    ...
                    var settings = $.spEasyForms.utilities.siteRelativePathAsAbsolutePath("/Style Library/SPEasyFormsAssets/2015.01.05/Pages/SPEasyFormsSettings.aspx") +
        ...
        insertSiteSettingsLink: function (opt) {
            ...
            if (scaLink.length > 0) {
                ...
                if (siteCollectionAdministrationList.length > 0) {
                    ...
                    var settings = $.spEasyForms.utilities.siteRelativePathAsAbsolutePath("/Style Library/SPEasyFormsAssets/2015.01.05/Pages/SPEasyFormsSiteSettings.aspx") +
                        "?Source=" + encodeURIComponent(source);
        ...
        loadDynamicStyles: function (options) {
            var opt = $.extend({}, spEasyForms.defaults, options);
            opt.currentConfig = $.spEasyForms.configManager.get(opt);
            opt.source = "~sitecollection/Style Library/SPEasyFormsAssets/2015.01.05/Css/jquery-ui-smoothness/jquery-ui.css";
    ...
    $.spEasyForms.configManager = {
        ...
        *********************************************************************/
        set: function (options) {
            ...
            opt.currentConfig.version = "2015.01.05";
        ...
        *********************************************************************/
        wireRibbonButtonEvents: function (options) {
            ...
            $("#spEasyFormsHelpLink").click(function () {
                var helpFile = $.spEasyForms.utilities.siteRelativePathAsAbsolutePath("/Style Library/SPEasyFormsAssets/2015.01.05/Help/speasyforms_help.aspx");
...
(function ($) {
    ...
    $.fn.cleditor = function (options) {
        if (!cssLoaded) {
            var css = $.spEasyForms.utilities.siteRelativePathAsAbsolutePath('/Style Library/SPEasyFormsAssets/2015.01.05/Css/jquery.cleditor.css');

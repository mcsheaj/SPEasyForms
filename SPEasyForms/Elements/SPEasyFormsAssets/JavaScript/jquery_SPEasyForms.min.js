 ...
 *    http://www.opensource.org/licenses/mit-license.php
 */
(function(n){var t=n.spEasyForms.containerCollection,i=n.spEasyForms.baseContainer,r={containerType:"Tabs",fieldCollectionsDlgTitle:"Enter the names of the tabs, one per line",fieldCollectionsDlgPrompt:"Tab Names (one per line):",transform:function(t){var i=n.extend({},n.spEasyForms.defaults,t),u;i.result=[];i.divId="spEasyFormsTabDiv"+i.index;var f="speasyforms-container speasyforms-tabs speasyforms-tabs"+i.index+" ui-tabs ui-widget ui-widget-content ui-corner-all",r="spEasyFormsTabsList"+i.index,e="speasyforms-tabs speasyforms-tabs"+i.index+" ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all",o=n("#"+i.containerId);return o.append("<div id='"+i.divId+"' class='"+f+"'><ul id='"+r+"' class='"+e+" role='tablist'><\/ul><\/div>"),u=0,n.each(i.currentContainerLayout.fieldCollections,function(n,t){t.fields.length>u&&(u=t.fields.length)}),n.each(i.currentContainerLayout.fieldCollections,function(t,u){i.collectionIndex=i.index+""+t;i.parentElement="spEasyFormsTabsDiv"+i.collectionIndex;i.labelId="spEasyFormsTabsLabel"+i.collectionIndex;i.collectionType="tab";i.fieldCollection=u;i.tableClass="speasyforms-tabs";var f="speasyforms-tabs speasyforms-tabs"+i.collectionIndex+" ui-state-default ui-corner-top";n("#"+r).append("<li id='"+i.labelId+"' class='"+f+"' role='tab' aria-controls='"+i.parentElement+"' tabindex='0'><a href='#"+i.parentElement+"'>"+u.name+"<\/a><\/li>");n("#"+i.divId).append("<div id='"+i.parentElement+"' aria-labelledby='"+i.labelId+"' ' class='ui-tabs-panel ui-widget-content ui-corner-bottom' role='tabpanel'>");n.spEasyForms.baseContainer.appendFieldCollection(i)}),n("#"+r).find("li").attr("aria-selected","false"),n("#"+r).find("li:first").attr("aria-selected","true").addClass("ui-tabs-active").addClass("ui-state-active"),n("#"+i.divId).find("div.ui-tabs-panel").attr("aria-hidden","true".attr("aria-expanded","false")).hide(),n("#"+i.divId).find("div.ui-tabs-panel:first").attr("aria-hidden","false").attr("aria-expanded","true").show(),n("#"+r).find("a").click(function(){return n("#"+r).find("li").attr("aria-selected","false").removeClass("ui-tabs-active").removeClass("ui-state-active"),n(this).closest("li").attr("aria-selected","true").addClass("ui-tabs-active").addClass("ui-state-active"),n("#"+i.divId).find("div.ui-tabs-panel").attr("aria-hidden","true").attr("aria-expanded","false").hide(),n(n(this).attr("href")).attr("aria-hidden","false").attr("aria-expanded","true").show(),!1}),i.result},postTransform:function(t){var i=n.extend({},n.spEasyForms.defaults,t);i.divId="spEasyFormsTabDiv"+i.index;n("#"+i.divId+" table.speasyforms-tabs").each(function(){var t=n(this)[0].id.replace("tabTable",""),i;n(this).find("tr:not([data-visibilityhidden='true']) td.ms-formbody").length===0?(n(this).parent().css("display")!=="none"&&(i=-1,n(this).parent().attr("aria-hidden","true").attr("aria-expanded","false").removeAttr("tabindex").hide(),n("#spEasyFormsTabsLabel"+t).removeClass("ui-tabs-active").removeClass("ui-state-active").attr("aria-selected","false"),n(this).parent().next().length>0&&(i=n(this).parent().next()[0].id.replace("spEasyFormsTabsDiv",""),n(this).parent().next().show(),n("li.speasyforms-tabs"+i).addClass("ui-tabs-active").addClass("ui-state-active").attr("aria-selected","true"))),n(".speasyforms-tabs"+t).attr("aria-hidden","true").hide()):n(".speasyforms-tabs"+t).attr("aria-hidden","false").show()})},preSaveItem:function(t){var i=n.extend({},n.spEasyForms.defaults,t),r=!1;return n("#spEasyFormsTabDiv"+i.index).find("table.speasyforms-tabs").each(function(t,u){n(u).find(".ms-formbody span.ms-formvalidation").length>0?(n("a[href$='#spEasyFormsTabsDiv"+i.index+""+t+"']").addClass("speasyforms-tabvalidationerror"),r||(n("#spEasyFormsTabDiv"+i.index).find("div.ui-tabs-panel").hide(),n(u).closest("div").show(),n("#spEasyFormsTabDiv"+i.index).find("li").removeClass("ui-tabs-active").removeClass("ui-state-active"),n("#spEasyFormsTabDiv"+i.index).find("a[href='#"+n(u).closest("div")[0].id+"']").closest("li").addClass("ui-tabs-active").addClass("ui-state-active"),r=!0)):n("a[href$='#spEasyFormsTabsDiv"+i.index+""+t+"']").removeClass("speasyforms-tabvalidationerror")}),!0}};t.containerImplementations.tabs=n.extend({},i,r)})(spefjQuery);
/*

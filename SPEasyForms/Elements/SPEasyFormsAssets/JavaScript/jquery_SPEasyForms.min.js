 ...
 *    http://www.opensource.org/licenses/mit-license.php
 */
(function(n){var t=n.spEasyForms.containerCollection,i=n.spEasyForms.baseContainer,r={containerType:"Columns",fieldCollectionsDlgTitle:"Enter the names of the columns, one per line; these are only displayed on the settings page, not on the form itself.",fieldCollectionsDlgPrompt:"Column Names (one per line):",transform:function(i){var f=n.extend({},n.spEasyForms.defaults,i),a=[],v="spEasyFormsColumnsOuterTable"+f.index,s,c,u,h,e,o;for(n("#"+f.containerId).append("<table id='"+v+"' class='speasyforms-container speasyforms-columns'><\/table>"),s=[],n.each(f.currentContainerLayout.fieldCollections,function(i,r){var u={};u.name=r.name;u.fields=[];n.each(r.fields,function(n,i){var r=t.rows[i.fieldInternalName];r&&!r.fieldMissing&&u.fields.push(i)});u.fields.length>0&&s.push(u)}),c=0,n.each(s,function(n,t){t.fields.length>c&&(c=t.fields.length)}),u=0;u<c;u++)for(h="spEasyFormsColumnRow"+f.index+""+u,n("#"+v).append("<tr id='"+h+"' class='speasyforms-columnrow'><\/tr>"),e=0;e<s.length;e++){var y=s[e],l="spEasyFormsColumnCell"+f.index+""+u+""+e,p="spEasyFormsInnerTable"+f.index+""+u+""+e;if(y.fields.length>u){var w=y.fields[u],r=t.rows[w.fieldInternalName],b=r.row.find("iframe[id$='TextField_iframe']").length>0;b||!r||r.fieldMissing||(a.push(w.fieldInternalName),r?(r.row.find("td.ms-formbody").find("h3.ms-standardheader").length===0&&(o=r.row.find("td.ms-formlabel"),window.location.href.toLowerCase().indexOf("speasyformssettings.aspx")>=0&&r.row.find("td.ms-formbody").prepend("<div data-transformAdded='true'>&nbsp;<\/div>"),o.html()==="Content Type"?r.row.find("td.ms-formbody").prepend("<h3 class='ms-standardheader'><nobr>"+o.html()+"<\/nobr><\/h3>"):r.row.find("td.ms-formbody").prepend(o.html()),r.row.find("td.ms-formbody").find("h3.ms-standardheader").attr("data-transformAdded","true"),o.hide(),o.attr("data-transformHidden","true")),n("#"+h).append("<td id='"+l+"' class='speasyforms-columncell'><table id='"+p+"' style='width: 100%'><\/table><\/td>"),r.row.appendTo("#"+p)):n("#"+h).append("<td id='"+l+"' class='speasyforms-columncell'>&nbsp;<\/td>"))}else n("#"+h).append("<td id='"+l+"' class='speasyforms-columncell'>&nbsp;<\/td>")}return a},postTransform:function(t){var i=n.extend({},n.spEasyForms.defaults,t),r="spEasyFormsColumnsOuterTable"+i.index;n("#"+r+" tr.speasyforms-columnrow").each(function(){n(this).find("tr:not([data-visibilityhidden='true']) td.ms-formbody").length===0?n(this).hide():n(this).show()})}};t.containerImplementations.columns=n.extend({},i,r)})(spefjQuery);
/*

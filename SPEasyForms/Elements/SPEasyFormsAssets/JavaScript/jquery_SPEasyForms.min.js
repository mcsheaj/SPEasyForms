 ...
 *    http://www.opensource.org/licenses/mit-license.php
 */
(function(n){var t=n.spEasyForms.containerCollection,i=n.spEasyForms.baseContainer,r={containerType:"Accordion",fieldCollectionsDlgTitle:"Enter the names of the accordion content areas, one per line",fieldCollectionsDlgPrompt:"Content Area Names (one per line):",transform:function(i){var r=n.extend({},n.spEasyForms.defaults,i),f=[],u="spEasyFormsAccordionDiv"+r.index,e="speasyforms-container speasyforms-accordion speasyforms-accordion"+r.index;return n("#"+r.containerId).append("<div id='"+u+"' class='"+e+"'><\/div>"),n.each(r.currentContainerLayout.fieldCollections,function(i,e){var o="speasyforms-accordion speasyforms-accordion"+r.index+""+i,s="spEasyFormsAccordionTable"+r.index+""+i,h="spEasyFormsAccordionHeader"+r.index+""+i;n("#"+u).append("<h3 id='"+h+"' class='"+o+"'>"+e.name+"<\/h3>");n("#"+u).append("<div><table class='"+o+"' id='"+s+"'><\/table><\/div>");n.each(e.fields,function(n,i){var r=t.rows[i.fieldInternalName],u;r&&(u=r.row.find("iframe[id$='TextField_iframe']").length>0,u||r.fieldMissing||(f.push(i.fieldInternalName),r.row.appendTo("#"+s)))})}),n("#"+u).accordion({heightStyle:"auto",active:!1,collapsible:!0}),f},postTransform:function(t){var i=n.extend({},n.spEasyForms.defaults,t),r="spEasyFormsAccordionDiv"+i.index;n("#"+r+" table.speasyforms-accordion").each(function(){var t=n(this)[0].id.replace("spEasyFormsAccordionTable","");n(this).find("tr:not([data-visibilityhidden='true']) td.ms-formbody").length===0?(n("#spEasyFormsAccordionHeader"+t).hide(),n("#spEasyFormsAccordionHeader"+t).next().hide()):n("#spEasyFormsAccordionHeader"+t).show()})},preSaveItem:function(t){var i=n.extend({},n.spEasyForms.defaults,t),r="spEasyFormsAccordionDiv"+i.index,u=!1;return n("#"+r).find("table.speasyforms-accordion").each(function(t,f){n(f).find(".ms-formbody span.ms-formvalidation").length>0?(n("#spEasyFormsAccordionHeader"+i.index+""+t).addClass("speasyforms-accordionvalidationerror"),u||(n("#"+r).accordion({active:t}),u=!0)):n("#spEasyFormsAccordionHeader"+i.index+""+t).removeClass("speasyforms-accordionvalidationerror")}),!0}};t.containerImplementations.accordion=n.extend({},i,r)})(spefjQuery);
/*
 ...
 *    http://www.opensource.org/licenses/mit-license.php
 */
(function(n){var t=n.spEasyForms.containerCollection,i=n.spEasyForms.baseContainer,r={containerType:"Tabs",fieldCollectionsDlgTitle:"Enter the names of the tabs, one per line",fieldCollectionsDlgPrompt:"Tab Names (one per line):",transform:function(i){var r=n.extend({},n.spEasyForms.defaults,i),e=[],f;r.divId="spEasyFormsTabDiv"+r.index;var o="speasyforms-container speasyforms-tabs speasyforms-tabs"+r.index+" ui-tabs ui-widget ui-widget-content ui-corner-all",u="spEasyFormsTabsList"+r.index,s="speasyforms-container speasyforms-tabs speasyforms-tabs"+r.index+" ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all",h=n("#"+r.containerId);return h.append("<div id='"+r.divId+"' class='"+o+"'><ul id='"+u+"' class='"+s+"'><\/ul><\/div>"),f=0,n.each(r.currentContainerLayout.fieldCollections,function(n,t){t.fields.length>f&&(f=t.fields.length)}),n.each(r.currentContainerLayout.fieldCollections,function(i,f){var h="speasyforms-tabs speasyforms-tabs"+r.index+""+i+" ui-state-default ui-corner-top",c="speasyforms-container speasyforms-tabs speasyforms-tabs"+r.index+""+i,o="spEasyFormsTabsDiv"+r.index+""+i,s="spEasyFormsTabsTable"+r.index+""+i;n("#"+u).append("<li class='"+h+"'><a href='#"+o+"'>"+f.name+"<\/a><\/li>");n("#"+r.divId).append("<div id='"+o+"' class='ui-tabs-panel ui-widget-content ui-corner-bottom'><table class='"+c+"' id='"+s+"'><\/table><\/div>");n.each(f.fields,function(n,i){var r=t.rows[i.fieldInternalName],u;r&&(u=r.row.find("iframe[id$='TextField_iframe']").length>0,u||r.fieldMissing||(e.push(i.fieldInternalName),r&&r.row.appendTo("#"+s)))})}),n("#"+u).find("li:first").addClass("ui-tabs-active").addClass("ui-state-active"),n("#"+r.divId).find("div.ui-tabs-panel").hide(),n("#"+r.divId).find("div.ui-tabs-panel:first").show(),n("#"+u).find("a").click(function(){return n("#"+u).find("li").removeClass("ui-tabs-active").removeClass("ui-state-active"),n(this).closest("li").addClass("ui-tabs-active").addClass("ui-state-active"),n("#"+r.divId).find("div.ui-tabs-panel").hide(),n(n(this).attr("href")).show(),!1}),e},postTransform:function(t){var i=n.extend({},n.spEasyForms.defaults,t);i.divId="spEasyFormsTabDiv"+i.index;n("#"+i.divId+" table.speasyforms-tabs").each(function(){var i=n(this)[0].id.replace("spEasyFormsTabsTable",""),t;n(this).find("tr:not([data-visibilityhidden='true']) td.ms-formbody").length===0?(n(this).parent().css("display")!=="none"&&(t=-1,n(this).parent().next().length>0&&(t=n(this).parent().next()[0].id.replace("spEasyFormsTabsDiv",""),n(this).parent().next().show(),n("li.speasyforms-tabs"+t).addClass("ui-tabs-active").addClass("ui-state-active")),n(this).parent().hide()),n(".speasyforms-tabs"+i).hide()):n(".speasyforms-tabs"+i).show()})},preSaveItem:function(t){var i=n.extend({},n.spEasyForms.defaults,t),r=!1;return n("#spEasyFormsTabDiv"+i.index).find("table.speasyforms-tabs").each(function(t,u){n(u).find(".ms-formbody span.ms-formvalidation").length>0?(n("a[href$='#spEasyFormsTabsDiv"+i.index+""+t+"']").addClass("speasyforms-tabvalidationerror"),r||(n("#spEasyFormsTabDiv"+i.index).find("div.ui-tabs-panel").hide(),n(u).closest("div").show(),n("#spEasyFormsTabDiv"+i.index).find("li").removeClass("ui-tabs-active").removeClass("ui-state-active"),n("#spEasyFormsTabDiv"+i.index).find("a[href='#"+n(u).closest("div")[0].id+"']").closest("li").addClass("ui-tabs-active").addClass("ui-state-active"),r=!0)):n("a[href$='#spEasyFormsTabsDiv"+i.index+""+t+"']").removeClass("speasyforms-tabvalidationerror")}),!0}};t.containerImplementations.tabs=n.extend({},i,r)})(spefjQuery);
/*
 ...
 *    http://www.opensource.org/licenses/mit-license.php
 */
(function(n){var i;if(n&&n.spEasyForms&&!("LookupDetailAdapter"in n.spEasyForms.adapterCollection.adapterImplementations)){var r=n.spEasyForms.containerCollection,t=n.spEasyForms.visibilityRuleCollection,u=n.spEasyForms.adapterCollection,f=n.spEasyForms.sharePointFieldRows;n.spEasyForms.lookupDetailAdapter={type:"LookupDetailAdapter",supportedTypes:function(){return["SPFieldText","SPFieldNote","SPFieldMultiLine","SPFieldChoice","SPFieldMultiChoice","SPFieldDateTime","SPFieldBoolean","SPFieldURL","SPFieldUser","SPFieldUserMulti"]},transform:function(u){var e=n.extend({},n.spEasyForms.defaults,u),o=e.adapter,s=r.rows[o.columnNameInternal],h;s&&(h=r.rows[o.parentColumnInternal],h.row.find("select").attr("data-relationshipListListener")!=="true"&&h.row.find("select").attr("data-relationshipListListener","true").change(function(){var c=n(this);o.readOnly&&(e.row=s,t.scrubCollection(n([e.row])));var l="<Query><Where><Eq><FieldRef Name='ID' /><Value Type='Counter'>"+c.val()+"<\/Value><\/Eq><\/Where><\/Query>",u="<ViewFields>",h=[];n.each(Object.keys(e.adapters),function(n,t){var i=e.adapters[t];i.parentColumnInternal===o.parentColumnInternal&&(h.push(i),u+="<FieldRef Name='"+i.relationshipListChildColumn+"'><\/FieldRef>")});u+="<\/ViewFields>";n().SPServices({operation:"GetListItems",async:!1,listName:o.relationshipList,CAMLQuery:l,CAMLViewFields:u,completefunc:function(u){n(u.responseXML).SPFilterNode("z:row").each(function(){var u=n(this);n.each(n(h),function(o,s){var c,l,h;if(e.row=r.rows[s.columnNameInternal],c=u.attr("ows_"+s.relationshipListChildColumn),typeof c!="undefined"&&c!==null)switch(e.row.spFieldType){case"SPFieldUser":case"SPFieldUserMulti":if(e.value=u.attr("ows_"+s.relationshipListChildColumn),e.value.indexOf(";#")>-1)for(l=e.value.split(";#"),e.value="",h=1;h<l.length;h+=2)e.value.length>0&&(e.value+=";"),e.value+=l[h];break;case"SPFieldDateTime":e.value=u.attr("ows_"+s.relationshipListChildColumn).replace(/-/g,"/");break;case"SPFieldURL":e.value=u.attr("ows_"+s.relationshipListChildColumn).replace(", ","|");break;default:e.value=u.attr("ows_"+s.relationshipListChildColumn).replace(/;#/g,";")}else e.value="";f.setValue(e);s.readOnly&&(e.row.spFieldType.indexOf("User")<0?(t.scrubCollection(n([e.row.row])),t.stateHandlers.readOnly(e)):i.delayResetReadonly(e))})})}})}));o.readOnly&&(e.row=s,t.scrubCollection(n([e.row])),t.stateHandlers.readOnly(e))},delayResetReadonly:function(i){var r=n.extend({},n.spEasyForms.defaults,i);setTimeout(function(){t.scrubCollection(n([r.row.row]));t.stateHandlers.readOnly(r)},1e3)},toEditor:function(n){this.getRelationshipHelper(n).constructDialog()},launchDialog:function(t){var i=this.getRelationshipHelper(t);i.clearDialog();i.initControls();i.initDialog();n("#lookupDetailDialogTable").append("<tr class='implementation-specific'><td><\/td><td><input type='checkbox' id='lookupDetailReadOnly' "+(!t.adapter||t.adapter.readOnly?"checked = 'checked'":"")+" /> Read Only<\/td><\/tr>");n("#lookupDetailDialog").dialog("open")},getRelationshipHelper:function(t){var r=n.extend({},n.spEasyForms.defaults,t);return r.relationship={type:i.type,dialogDiv:"lookupDetailDialog",relationshipListColumn:{id:"lookupDetailRelationshipList",displayName:"Relationship List"},relationshipChildColumn:{id:"lookupDetailRelationshipDetailColumn",displayName:"Detail Column"},formListColumn:{id:"lookupDetailList",displayName:"This List"},formParentColumn:{id:"lookupDetailLookupColumn",displayName:"Form Lookup Column"},formChildColumn:{id:"lookupDetailDetailColumn",displayName:"Form Detail Column"},updateCallback:function(t){t.readOnly=n("#lookupDetailReadOnly").is(":checked")}},new n.spEasyForms.relationshipListAdapterHelper(r)}};i=n.spEasyForms.lookupDetailAdapter;u.adapterImplementations[i.type]=i}})(typeof spefjQuery=="undefined"?null:spefjQuery);
/*

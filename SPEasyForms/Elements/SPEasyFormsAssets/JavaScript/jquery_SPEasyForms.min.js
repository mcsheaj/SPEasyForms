 ...
 *    http://www.opensource.org/licenses/mit-license.php
 */
(function(n,t){var i=n.spEasyForms.containerCollection,r;n.spEasyForms.baseContainer={fieldCollectionsDlgTitle:"Enter the names of the field collections, one per line",fieldCollectionsDlgPrompt:"Field Collection Names (one per line):",toEditor:function(t){var r=n.extend({},n.spEasyForms.defaults,t),u=[],f=n("<ol>");return r.currentContainer.append(f),n.each(r.currentContainerLayout.fieldCollections,function(t,e){var o,s;e.name||(e.name=e.containerType);r.currentContainerLayout=e;r.currentContainerParent=f;o=n.spEasyForms.utilities.jsCase(e.containerType);o in i.containerImplementations&&(r.impl=i.containerImplementations[o],r.currentContainer=i.appendContainer(r),e.index=r.currentContainer.attr("data-containerindex"),typeof r.impl.toEditor=="function"&&(r.currentContainerParent=r.currentContainer,s=r.impl.toEditor(r),n.merge(u,s)))}),this.wireDialogEvents(r),u},toLayout:function(t){var r=n.extend({},n.spEasyForms.defaults,t),u={name:n(r.container).attr("data-containername"),containerType:n(r.container).attr("data-containertype"),index:n(r.container).attr("data-containerindex"),fieldCollections:[]},f=n(r.container).children("ol").children("li");return n.each(f,function(t,f){var e={name:n(f).attr("data-containername"),containerType:n(f).attr("data-containertype"),index:n(f).attr("data-containerindex"),fields:[]},o=n.spEasyForms.utilities.jsCase(n(f).attr("data-containertype"));o in i.containerImplementations&&(r.container=f,e=i.containerImplementations[o].toLayout(r));u.fieldCollections.push(e)}),u},settings:function(t){var i=n.extend({},n.spEasyForms.defaults,t);this.wireDialogEvents(i);n("#settingsCollectionNames").show().val("");n("#settingsCollectionNames").attr("title",this.fieldCollectionsDlgTitle);n("label[for='settingsCollectionNames']").show().text(this.fieldCollectionsDlgPrompt);i.currentContainerLayout?(n("#containerSettingsDialog").dialog("option","title","Edit Container"),n("#settingsContainerName").val(i.currentContainerLayout.name),n("#settingsContainerId").val(i.currentContainerLayout.index),n("#settingsContainerType").val(i.currentContainerLayout.containerType),i.currentContainerLayout.containerType==="FieldCollection"&&(n("#settingsCollectionNames").hide(),n("label[for='settingsCollectionNames']").hide())):(n("#containerSettingsDialog").dialog("option","title","Add Container"),n("#settingsContainerName").val(""),n("#settingsContainerId").val(""),n("#settingsContainerType").val(i.containerType));n("#containerSettingsDialog").dialog("open")},wireDialogEvents:function(t){var r=n.extend({},n.spEasyForms.defaults,t),u={width:450,modal:!0,buttons:{Ok:function(){var t,e,o,u,f;return n("#settingsContainerId").val().length===0?(t={name:n("#settingsContainerName").val(),containerType:n("#settingsContainerType").val(),fieldCollections:[]},t.name||(t.name=t.containerType),f=n("#settingsCollectionNames").val().split("\n"),n.each(n(f),function(n,i){i.trim().length>0&&t.fieldCollections.push({name:i,containerType:"FieldCollection",fields:[]})}),r.currentConfig=n.spEasyForms.configManager.get(r),r.currentConfig.layout.def.push(t),n.spEasyForms.configManager.set(r),r.currentContainerLayout=t,r.currentContainerParent=n(".speasyforms-panel").children("ol.speasyforms-nestedsortable"),e=n.spEasyForms.utilities.jsCase(t.containerType),e in i.containerImplementations&&(r.impl=i.containerImplementations[e],r.currentContainer=i.appendContainer(r),t.index=r.currentContainer.attr("data-containerindex"),typeof r.impl.toEditor=="function"&&r.impl.toEditor(r))):(o=n("#settingsContainerId").val(),u=n("#spEasyFormsContainer"+o),n("#settingsContainerName").val().length>0&&(r.currentContainerLayout.name=n("#settingsContainerName").val(),r.currentContainerLayout.name.length===0&&(r.currentContainerLayout.name=r.currentContainerLayout.containerType),u.attr("data-containername",r.currentContainerLayout.name),u.find(".speasyforms-itemtitle:first").text(r.currentContainerLayout.name),r.currentContainerLayout.name!=r.currentContainerLayout.containerType&&u.find(".speasyforms-itemtype:first").text(r.currentContainerLayout.containerType)),f=n("#settingsCollectionNames").val().split("\n"),n.each(n(f),function(t,f){var o,e;f.trim().length>0&&(r.currentContainerLayout={name:f.trim(),containerType:"FieldCollection",fields:[]},o=i.createFieldCollection(r),u.find("ol").length===0&&u.append("<ol>"),r.currentContainerParent=u.children("ol"),r.impl=n.spEasyForms.fieldCollection,e=i.appendContainer(r),e.find(".speasyforms-itemtitle").html(r.currentContainerLayout.name),r.currentContainerLayout.name!==r.currentContainerLayout.containerType&&e.find(".speasyforms-itemtype").html("&nbsp;["+r.currentContainerLayout.containerType+"]"),e.find(".speasyforms-nestedsortable-content").append(o))}),r.currentConfig=i.toConfig(r),n.spEasyForms.configManager.set(r)),r.refresh=n.spEasyForms.refresh.form,i.toEditor(r),n("#containerSettingsDialog").dialog("close"),!1},Cancel:function(){return n("#containerSettingsDialog").dialog("close"),!1}},autoOpen:!1};n("#containerSettingsDialog").dialog(u)},appendRow:function(t){var i=n.extend({},n.spEasyForms.defaults,t),u=!1,f,r;return i.rowInfo&&!i.rowInfo.fieldMissing&&(f=i.rowInfo.row.find("iframe[id$='TextField_iframe']").length>0,f||(i.table.append(i.rowInfo.row),i.headerOnTop&&(r=i.rowInfo.row.find("td.ms-formlabel"),window.location.href.toLowerCase().indexOf("speasyformssettings.aspx")>=0&&i.rowInfo.row.find("td.ms-formbody").prepend("<div data-transformAdded='true'>&nbsp;<\/div>"),r.html()==="Content Type"?i.rowInfo.row.find("td.ms-formbody").prepend("<h3 data-transformAdded='true' class='ms-standardheader'><nobr>"+r.html()+"<\/nobr><\/h3>"):i.rowInfo.row.find("td.ms-formbody").prepend("<h3 data-transformAdded='true' class='ms-standardheader'><nobr>"+r.html()+"<\/nobr><\/h3>"),r.attr("data-transformHidden","true").hide()),u=!0)),u},appendFieldCollection:function(t){var r=n.extend({},n.spEasyForms.defaults,t),u,f;r.fieldCollection.containerType||(r.fieldCollection.containerType="FieldCollection");r.fieldCollection.name||(r.fieldCollection.name=r.fieldCollection.containerType);u=n.spEasyForms.utilities.jsCase(r.fieldCollection.containerType);u in i.containerImplementations&&(impl=i.containerImplementations[u],typeof impl.transform=="function"&&(r.currentContainerLayout=r.fieldCollection,f=n("<div/>",{"class":"speasyforms-container","data-containerindex":r.currentContainerLayout.index,"data-containertype":r.currentContainerLayout.containerType,"data-containername":r.currentContainerLayout.name}),r.parentElement.append(f),r.currentContainerParent=f,n.merge(r.result,impl.transform(r))))}};n.spEasyForms.fieldCollection={containerType:"FieldCollection",cannotBeAdded:!0,noChildren:!0,needsParent:!0,transform:function(t){var r=n.extend({},n.spEasyForms.defaults,t),u=[];return r.table=n("<table/>",{role:"presentation",id:r.collectionType+"Table"+r.collectionIndex,"class":"speasyforms-fieldcollection "+r.tableClass,cellspacing:"5"}),r.currentContainerParent.append(r.table),n.each(r.fieldCollection.fields,function(t,f){r.rowInfo=i.rows[f.fieldInternalName];n.spEasyForms.baseContainer.appendRow(r)&&u.push(f.fieldInternalName)}),u},postTransform:function(t){var r=n.extend({},n.spEasyForms.defaults,t),i=n("div.speasyforms-container[data-containerindex='"+r.currentContainerLayout.index+"']");i.find("tr:not([data-visibilityhidden='true']) td.ms-formbody").length===0?i.attr("data-speasyformsempty","1").hide():i.attr("data-speasyformsempty","0").show()},preSaveItem:function(t){var r=n.extend({},n.spEasyForms.defaults,t),i=n("div.speasyforms-container[data-containerindex='"+r.currentContainerLayout.index+"']");i.find("span.ms-formvalidation").length>0?i.attr("data-speasyforms-validationerror","1"):i.attr("data-speasyforms-validationerror","0")},toEditor:function(r){var u=n.extend({},n.spEasyForms.defaults,r),f=[],e=i.createFieldCollection(u);return n.each(u.currentContainerLayout.fields,function(r,o){u.row=i.rows[o.fieldInternalName];u.row===t&&(u.row={displayName:o.fieldInternalName,internalName:o.fieldInternalName,spFieldType:o.fieldInternalName,value:"",row:n("<tr><td class='ms-formlabel'><h3 class='ms-standardheader'><\/h3><\/td><td class='ms-formbody'><\/td><\/tr>"),fieldMissing:!0});e.append(i.createFieldRow(u));f.push(o.fieldInternalName)}),u.currentContainer.find(".speasyforms-itemtitle").html(u.currentContainerLayout.name),u.currentContainerLayout.name!==u.currentContainerLayout.containerType&&u.currentContainer.find(".speasyforms-itemtype").html("&nbsp;["+u.currentContainerLayout.containerType+"]"),u.currentContainer.find(".speasyforms-nestedsortable-content").append(e),f},toLayout:function(t){var i=n.extend({},n.spEasyForms.defaults,t),u=n(i.container).find("tr:not(:first)"),r={name:n(i.container).attr("data-containername"),containerType:n(i.container).attr("data-containertype"),index:n(i.container).attr("data-containerindex"),fields:[]};return n.each(u,function(t,i){var u=n(i).find("td");r.fields.push({fieldInternalName:n(u[1]).text()})}),r}};r=n.extend({},n.spEasyForms.baseContainer,n.spEasyForms.fieldCollection);i.containerImplementations.fieldCollection=r})(spefjQuery);
/*
 ...
 *    http://www.opensource.org/licenses/mit-license.php
 */
(function(n){var t=n.spEasyForms.containerCollection,i=n.spEasyForms.baseContainer,r={containerType:"Accordion",fieldCollectionsDlgTitle:"Enter the names of the accordion pages, one per line",fieldCollectionsDlgPrompt:"Page Names (one per line):",transform:function(t){var i=n.extend({},n.spEasyForms.defaults,t);i.result=[];var u="spEasyFormsAccordionDiv"+i.currentContainerLayout.index,r=n("<div/>",{id:u,"class":"speasyforms-accordion"});i.currentContainerParent.append(r);n.each(i.currentContainerLayout.fieldCollections,function(t,u){i.collectionIndex=i.currentContainerLayout.index+"_"+t;i.parentElement=n("<div/>",{id:i.parentElement});i.collectionType="accordion";i.fieldCollection=u;i.tableClass="speasyforms-accordion";var f=n("<h3>",{id:"spEasyFormsAccordionHeader"+i.collectionIndex,"class":i.tableClass}).text(u.name);r.append(f);r.append(i.parentElement);n.spEasyForms.baseContainer.appendFieldCollection(i)});r.accordion({heightStyle:"content",active:!1,collapsible:!0,activate:function(n){n.preventDefault()}});r.on("mouseup","h3.speasyforms-accordion",function(){r.find("h3.speasyforms-accordion").removeClass("ui-accordion-header-active").removeClass("ui-state-active").removeClass("ui-corner-top").addClass("ui-corner-all");r.find(".ui-accordion-content").hide();n(this).addClass("ui-accordion-header-active").addClass("ui-state-active").addClass("ui-corner-top").removeClass("ui-corner-all");n(this).next().show();n.spEasyForms.containerCollection.postTransform(i)});return i.result},postTransform:function(t){for(var o,s,h=n.extend({},n.spEasyForms.defaults,t),c=h.currentContainerLayout.index,u=n("div.speasyforms-container[data-containerindex='"+c+"']"),r=u.children("div.speasyforms-accordion"),l=r.children("h3.ui-accordion-header"),f=r.children("div.ui-accordion-content "),e=!0,i=0;i<f.length;i++)o=n(f[i]).children(".speasyforms-container"),o.attr("data-speasyformsempty")==="1"?(s=r.accordion("option","active"),s===i&&r.accordion({active:i+1}),n(l[i]).hide()):e=!1;e?u.attr("data-speasyformsempty","1").hide():u.attr("data-speasyformsempty","0").show()},preSaveItem:function(t){var o=n.extend({},n.spEasyForms.defaults,t),s=o.currentContainerLayout.index,r=n("div.speasyforms-container[data-containerindex='"+s+"']"),u=r.children("div.speasyforms-accordion"),h=u.children("h3.ui-accordion-header"),f=u.children("div.ui-accordion-content "),i,e;for(r.attr("data-speasyforms-validationerror","0"),i=0;i<f.length;i++)e=n(f[i]).children(".speasyforms-container"),e.attr("data-speasyforms-validationerror")==="1"&&(r.attr("data-speasyforms-validationerror")==="0"&&(r.attr("data-speasyforms-validationerror","1"),u.accordion({active:i})),n(h[i]).addClass("speasyforms-accordionvalidationerror"));return!0}};t.containerImplementations.accordion=n.extend({},i,r)})(spefjQuery);
/*
 ...
 *    http://www.opensource.org/licenses/mit-license.php
 */
(function(n){var t=n.spEasyForms.containerCollection,i=n.spEasyForms.baseContainer,r={containerType:"Columns",fieldCollectionsDlgTitle:"Enter the names of the columns, one per line; these are only displayed on the settings page, not on the form itself.",fieldCollectionsDlgPrompt:"Column Names (one per line):",transform:function(t){var i=n.extend({},n.spEasyForms.defaults,t);i.result=[];var r="spEasyFormsColumnsOuterTable"+i.currentContainerLayout.index,u=n("<table/>",{role:"presentation",id:r,"class":"speasyforms-columns"}),f=n("<tr/>",{id:r+"Row"});return u.append(f),i.currentContainerParent.append(u),n.each(i.currentContainerLayout.fieldCollections,function(t,r){i.collectionIndex=i.currentContainerLayout.index+"_"+t;i.parentElement=n("<td/>",{id:"spEasyFormsColumnsCell"+i.collectionIndex});i.collectionType="columns";i.fieldCollection=r;i.tableClass="speasyforms-columncell";i.headerOnTop=!0;f.append(i.parentElement);n.spEasyForms.baseContainer.appendFieldCollection(i)}),i.result},postTransform:function(t){for(var o,i=n.extend({},n.spEasyForms.defaults,t),f=i.currentContainerLayout.index,r=n("div.speasyforms-container[data-containerindex='"+f+"']"),e=!0,u=0;u<i.currentContainerLayout.fieldCollections.length;u++)if(o="#spEasyFormsColumnsCell"+f+"_"+u,n(o).children("div.speasyforms-container").attr("data-speasyformsempty")!=="1"){e=!1;break}e?r.attr("data-speasyformsempty","1").hide():(r.attr("data-speasyformsempty","0").show(),i.tables=r.find("> table > tbody > tr > td > div > table.speasyforms-fieldcollection"),this.evenUpTableRows(i))},preSaveItem:function(t){var r=n.extend({},n.spEasyForms.defaults,t),u=r.currentContainerLayout.index,f=n("div.speasyforms-container[data-containerindex='"+u+"']"),i,e;for(f.attr("data-speasyforms-validationerror","0"),i=0;i<r.currentContainerLayout.fieldCollections.length;i++)if(e="#spEasyFormsColumnsCell"+u+"_"+i,n(e).children("div.speasyforms-container").attr("data-speasyforms-validationerror")==="1"){f.attr("data-speasyforms-validationerror","1");break}},evenUpTableRows:function(t){var e=n.extend({},n.spEasyForms.defaults,t),u=[],f=0,i,r;for(n.each(n(e.tables),function(t,i){var r=n(i).find("tr:not([data-visibilityhidden='true']) td.ms-formbody").closest("tr");u.push(r);r.length>f&&(f=r.length);n.each(n(r),function(t,i){n(i).css("height","auto")})}),i=0;i<f;i++)r=0,n.each(n(u),function(t,u){u.length>i&&n(u[i]).height()>r&&(r=n(u[i]).height())}),r>0&&n.each(n(u),function(t,u){u.length>i&&n(u[i]).height()!==r&&n(u[i]).height(r)})}};t.containerImplementations.columns=n.extend({},i,r)})(spefjQuery);
/*
 ...
 *    http://www.opensource.org/licenses/mit-license.php
 */
(function(n){var t=n.spEasyForms.containerCollection,i=n.spEasyForms.baseContainer,r={containerType:"Tabs",fieldCollectionsDlgTitle:"Enter the names of the tabs, one per line",fieldCollectionsDlgPrompt:"Tab Names (one per line):",transform:function(t){var i=n.extend({},n.spEasyForms.defaults,t);i.result=[];var e="spEasyFormsTabDiv"+i.currentContainerLayout.index,u="speasyforms-tabs",o="spEasyFormsTabList"+i.currentContainerLayout.index,r=n("<div/>",{id:e,"class":u}),f=n("<ul/>",{id:o,"class":"speasyforms-tablist"});r.append(f);i.currentContainerParent.append(r);n.each(i.currentContainerLayout.fieldCollections,function(t,e){i.collectionIndex=i.currentContainerLayout.index+"_"+t;i.parentElement=n("<div/>",{id:"spEasyFormsTabsDiv"+i.collectionIndex,"class":u});i.collectionType="tab";i.fieldCollection=e;i.tableClass=u;var o=n("<li/>",{id:"spEasyFormsTabsLabel"+i.collectionIndex,"class":u});o.append(n("<a/>",{href:"#spEasyFormsTabsDiv"+i.collectionIndex}).text(e.name));f.append(o);r.append(i.parentElement);n.spEasyForms.baseContainer.appendFieldCollection(i)});r.tabs({beforeLoad:function(n,t){t.jqXHR.abort()},create:function(){n(this).children("div").hide();n(this).children(".speasyforms-tabs:first").show()},activate:function(t,r){var u=r.newTab.context.hash;n(u).parent().children("div").hide();n(u).show();n.spEasyForms.containerCollection.postTransform(i)}});r.on("mouseup","a.ui-tabs-anchor",function(){r.tabs({active:n(this).parent().index()})});return i.result},postTransform:function(t){for(var o,s=n.extend({},n.spEasyForms.defaults,t),u=n("div.speasyforms-container[data-containerindex='"+s.currentContainerLayout.index+"']"),r=u.children("div.speasyforms-tabs"),f=r.children("div.speasyforms-tabs").children("div.speasyforms-container"),h=r.children("ul").children("li"),e=!0,i=0;i<f.length;i++)n(f[i]).attr("data-speasyformsempty")==="1"?(o=r.tabs("option","active"),o===i&&r.tabs({active:i+1}),n(h[i]).hide()):e=!1;e?u.attr("data-speasyformsempty","1").hide():u.attr("data-speasyformsempty","0").show()},preSaveItem:function(t){var e=n.extend({},n.spEasyForms.defaults,t),r=n("div.speasyforms-container[data-containerindex='"+e.currentContainerLayout.index+"']"),u=r.children("div.speasyforms-tabs"),f=u.children("div.speasyforms-tabs").children("div.speasyforms-container"),o=u.children("ul").children("li"),i;for(r.attr("data-speasyforms-validationerror","0"),i=0;i<f.length;i++)n(f[i]).attr("data-speasyforms-validationerror")==="1"&&(r.attr("data-speasyforms-validationerror")==="0"&&(r.attr("data-speasyforms-validationerror","1"),u.tabs({active:i})),n(o[i]).find("a").addClass("speasyforms-tabvalidationerror"));return!0}};t.containerImplementations.tabs=n.extend({},i,r)})(spefjQuery);
/*
 ...
 *    http://www.opensource.org/licenses/mit-license.php
 */
(function(n){var t=n.spEasyForms.containerCollection,r=n.spEasyForms.visibilityRuleCollection,u=n.spEasyForms.adapterCollection,i;n.spEasyForms.starRatingAdapter={type:"Star Rating",supportedTypes:function(){return["SPFieldNumber"]},transform:function(i){var u=n.extend({},n.spEasyForms.defaults,i),f,o,s,h,e;t.rows[u.adapter.columnNameInternal]&&(f=t.rows[u.adapter.columnNameInternal],o=f.value?f.value:0,r.getFormType(u)==="display"?n("#"+u.adapter.columnNameInternal+"Stars").length===0&&(s=f.row.find("td.ms-formbody"),h="<h3 class='ms-standardheader'>"+s.find("h3").html()+"<\/h3>",s.html("<div id='"+u.adapter.columnNameInternal+"Stars' class='speasyforms-stars'>").prepend(h),n("#"+u.adapter.columnNameInternal+"Stars").css("background-position","0px "+30*o+"px")):n("#"+u.adapter.columnNameInternal+"Stars").length===0&&(e=f.row.find("input"),e.hide(),e.parent().prepend("<div id='"+u.adapter.columnNameInternal+"Stars' class='speasyforms-stars'><div id='"+u.adapter.columnNameInternal+"StarsSlider' class='speasyforms-starsslider'><\/div><\/div>"),n("#"+u.adapter.columnNameInternal+"Stars").css("background-position","0px "+30*o+"px"),n("#"+u.adapter.columnNameInternal+"StarsSlider").click(function(t){var r=n(this).offset().left,i=Math.floor((t.pageX-r+15)/30);e.val(i);n("#"+u.adapter.columnNameInternal+"Stars").css("background-position","0px "+30*i+"px")})))},toEditor:function(r){var u=n.extend({},n.spEasyForms.defaults,r),f,e;n("#addStarRatingAdapterDialog").length===0&&(f="<div id='addStarRatingAdapterDialog' class='speasyforms-dialogdiv' title='Star Rating Adapter'>Would you like to add/remove a Star Rating adapter to '<span id='starRatingFieldName'><\/span>'?<\/div>",n("#spEasyFormsContainerDialogs").append(f));e={modal:!0,buttons:{Add:function(){if(n("#starRatingFieldName").text().length>0){var r={type:i.type,columnNameInternal:n("#starRatingFieldName").text()};u.adapters[r.columnNameInternal]=r;n.spEasyForms.configManager.set(u);u.refresh=n.spEasyForms.refresh.adapters;t.toEditor(u)}n("#addStarRatingAdapterDialog").dialog("close")},Remove:function(){return n("#starRatingFieldName").text().length>0&&n("#starRatingFieldName").text()in u.adapters&&(delete u.adapters[n("#starRatingFieldName").text()],n.spEasyForms.configManager.set(u)),n("#addStarRatingAdapterDialog").dialog("close"),u.refresh=n.spEasyForms.refresh.adapters,t.toEditor(u),!1}},autoOpen:!1,width:400};n("#addStarRatingAdapterDialog").dialog(e)},launchDialog:function(t){var i=n.extend({},n.spEasyForms.defaults,t);n("#starRatingFieldName").text(i.fieldName);n("#addStarRatingAdapterDialog").dialog("open")}};i=n.spEasyForms.starRatingAdapter;u.adapterImplementations[i.type]=i})(typeof spefjQuery=="undefined"?null:spefjQuery);
/*!
